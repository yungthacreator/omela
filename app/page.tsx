    ...
    <div className="wrap">
      ...
      <section className="heroSec"><div className="container heroGrid">
        <div className="heroTxt">
          <FI><h1 className="serif heroTi">Getting a repeat prescription<br/><span className="heroAc">should not feel this hard.</span></h1></FI>
          <FI delay={0.06}><p className="heroSub">Omela helps people stay on top of repeat prescriptions, status updates, and the next admin step, with Laura guiding the process from request to pickup or delivery.</p></FI>
          <FI delay={0.1}><p className="heroCredLine">For people, carers, and care teams. Starting with repeat prescriptions in the UK.</p></FI>
      ...
      <section id="how" className="sec"><div className="container">
        <FI><div className="shW"><h2 className="serif shT">From running low to knowing what happens next.</h2><p className="shB">Laura helps you stay ahead, prepare the request, and follow the process without the usual guesswork.</p></div></FI>
        <div className="proofGrid">{[
          {icon:<Bell size={22}/>,title:"Know before you are caught short",body:"Laura reminds you before you run low, so repeat prescriptions do not become a last-minute problem.",tone:"warm"},
          {icon:<FileText size={22}/>,title:"Prepare the request with less friction",body:"Laura helps organise the refill request clearly, so the process feels cleaner and easier to manage.",tone:"blue"},
          {icon:<Package size={22}/>,title:"See where things stand",body:"Follow the journey from request to pickup or delivery, with clearer status and fewer unknowns.",tone:"green"},
      ...
      <section className="sec secTinted"><div className="container">
        <FI><div className="shW"><h2 className="serif shT">The problem is rarely the prescription. It is everything around it.</h2></div></FI>
      ...
      <section className="sec"><div className="container">
        <FI><div className="shW"><h2 className="serif shT">Built for the people carrying the admin.</h2></div></FI>
        <div className="audGrid">{[
          ...
          {icon:<Pill size={22}/>,title:"Pharmacies",desc:"For pharmacies that want clearer incoming requests and better communication over time.",color:c.warm},
      ...
      <section id="pricing" className="sec"><div className="container">
        <FI><div className="shW"><h2 className="serif shT">Clear plans for people and teams.</h2><p className="shB">Start simply, then grow into deeper coordination as your needs become more complex.</p></div></FI>
...
.heroSub{margin-top:16px;font-size:clamp(15px,2.2vw,17px);line-height:1.72;color:${c.sub};max-width:520px}
